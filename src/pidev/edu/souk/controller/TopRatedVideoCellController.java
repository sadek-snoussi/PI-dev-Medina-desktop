 ...
 * @author hp
 */
public class TopRatedVideoCellController {
    ...
    public TopRatedVideoCellController() {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/pidev/edu/souk/gui/topRatedVideoCell.fxml"));
