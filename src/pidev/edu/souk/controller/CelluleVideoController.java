 ...
 * @author hp
 */
public class CelluleVideoController {
    ...
    public CelluleVideoController() {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/pidev/edu/souk/gui/CelluleVideo.fxml"));
